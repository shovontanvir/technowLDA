...
const Skills = () => {
  return (
    <section className='lg:px-28 px-10 py-10 justify-start' id='skills' >
      <div className='lg:w-3/4' >
        ...
        <div>
          <p className='text-2xl text-[#FF7069] font-normal border-y-2 border-stale-400 uppercase'>
          C# / .NET / php / python / java / Objective-C Swift / javascript / HTML5 / CSS3 <br />
          </p>
          <p className='text-2xl font-normal border-b-2 border-stale- uppercase'>
